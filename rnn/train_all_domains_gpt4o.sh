...
MODEL_VERSIONS=("gpt-4o-2024-05-13" "gpt-4o-2024-08-06" "gpt-4o-2024-11-20" "chatgpt-4o-latest")
...
# Main function
main() {
    print_info "Starting training for all domains (GPT4o)..."
    ...
    summary_file="all_domains_gpt4o_training_summary.json"
...
if ! command -v nvidia-smi &> /dev/null; then
    print_warning "CUDA not detected, falling back to CPU"
    DEVICE="cpu"
else
    print_info "CUDA detected, using GPU for training"
fi

#!/usr/bin/env python3
"""
Script to plot GPT4 model performance results from outputs/domain_experiments/*/cv_results.json
...
def parse_cv_results():
    """Parse cv_results.json files from domain experiments for GPT4 models"""
    ...
    # Define GPT4 model versions in chronological order
    model_ids = [
        'gpt-4',
        'gpt-4-1106-preview',
        'gpt-4-0125-preview',
...
def get_model_order():
    """Define the chronological order of GPT4 models"""
    return [
        'GPT-4',
        'GPT-4-1106-preview',
        'GPT-4-0125-preview', 
...
def create_plots(data):
    ...
    fig.suptitle('GPT-4 Model Performance Across Domains and Time (RNN Classifiers)', fontsize=16, fontweight='bold')
...
def save_separate_plots(data):
    ...
    for metric in ['Acc', 'AUROC']:
        ...
        fig.suptitle(f'GPT-4 Model {metric} Performance Across Domains and Time (RNN Classifiers)', 
        ...
        # Save the plot
        filename = f'rnn_gpt4_{metric.lower()}_timeline.pdf'
...
def main():
    ...
    print("解析GPT4 cv_results.json文件...")
    ...
    plt.savefig('rnn_gpt4_combined_timeline.pdf', dpi=300, bbox_inches='tight')
    print("已保存 rnn_gpt4_combined_timeline.pdf")
    plt.close()

...
d.gpt4.orig_pubmed <- fread("data/gpt-4/bigram/fftnorm/pubmed_gpt-4.original.bigram.fftnorm.txt")
d.gpt4.samp_pubmed <- fread("data/gpt-4/bigram/fftnorm/pubmed_gpt-4.sampled.bigram.fftnorm.txt")

d.gpt4.orig_pubmed <- add_sid(d.gpt4.orig_pubmed)
d.gpt4.samp_pubmed <- add_sid(d.gpt4.samp_pubmed)

d.gpt4.orig_pubmed$type <- "Human"
d.gpt4.samp_pubmed$type <- "GPT-4"
...
ggsave("plot/pdf/org/gpt4_bigram_pubmed_fftnorm.pdf", plot=p, width=5, height=5)




d.gpt4.orig_xsum <- fread("data/gpt-4/bigram/fftnorm/xsum_gpt-4.original.bigram.fftnorm.txt")
d.gpt4.samp_xsum <- fread("data/gpt-4/bigram/fftnorm/xsum_gpt-4.sampled.bigram.fftnorm.txt")

d.gpt4.orig_xsum <- add_sid(d.gpt4.orig_xsum)
d.gpt4.samp_xsum <- add_sid(d.gpt4.samp_xsum)

d.gpt4.orig_xsum$type <- "Human"
d.gpt4.samp_xsum$type <- "GPT-4"
...
ggsave("plot/pdf/org/gpt4_bigram_xsum_fftnorm.pdf", plot=p, width=5, height=5)





d.gpt4.orig_writing <- fread("data/gpt-4/bigram/fftnorm/writing_gpt-4.original.bigram.fftnorm.txt")
d.gpt4.samp_writing <- fread("data/gpt-4/bigram/fftnorm/writing_gpt-4.sampled.bigram.fftnorm.txt")
...
d.gpt4.samp_writing$type <- "GPT-4"
...
ggsave("plot/pdf/org/gpt4_bigram_writing_fftnorm.pdf", plot=p, width=5, height=5)
...
d.gpt4.orig_pubmed <- fread("data/davinci/bigram/fftnorm/pubmed_davinci.original.bigram.fftnorm.txt")
d.gpt4.samp_pubmed <- fread("data/davinci/bigram/fftnorm/pubmed_davinci.sampled.bigram.fftnorm.txt")

d.gpt4.orig_pubmed <- add_sid(d.gpt4.orig_pubmed)
d.gpt4.samp_pubmed <- add_sid(d.gpt4.samp_pubmed)

d.gpt4.orig_pubmed$type <- "Human"
d.gpt4.samp_pubmed$type <- "Davinci"
...
ggsave("plot/pdf/org/davinci_bigram_pubmed_fftnorm.pdf", plot=p, width=5, height=5)




d.gpt4.orig_xsum <- fread("data/davinci/bigram/fftnorm/xsum_davinci.original.bigram.fftnorm.txt")
d.gpt4.samp_xsum <- fread("data/davinci/bigram/fftnorm/xsum_davinci.sampled.bigram.fftnorm.txt")

d.gpt4.orig_xsum <- add_sid(d.gpt4.orig_xsum)
d.gpt4.samp_xsum <- add_sid(d.gpt4.samp_xsum)

d.gpt4.orig_xsum$type <- "Human"
d.gpt4.samp_xsum$type <- "Davinci"
...
ggsave("plot/pdf/org/davinci_bigram_xsum_fftnorm.pdf", plot=p, width=5, height=5)





d.gpt4.orig_writing <- fread("data/davinci/bigram/fftnorm/writing_davinci.original.bigram.fftnorm.txt")
d.gpt4.samp_writing <- fread("data/davinci/bigram/fftnorm/writing_davinci.sampled.bigram.fftnorm.txt")
...
d.gpt4.samp_writing$type <- "Davinci"
...
ggsave("plot/pdf/org/davinci_bigram_writing_fftnorm.pdf", plot=p, width=5, height=5)